...
(function () {
  ...
  var I18N = {
    ru: {
      ...
      'about.title': 'Обо мне',
      'about.text': 'DigitalPr0 — fullstack-разработчик. Делаю сайты, бэкенды, Telegram-ботов и мобильные приложения под задачу. Работаю с Python, Node.js, PHP, Java, C# и Kotlin: REST и gRPC API, микросервисы, реалтайм-чаты, дашборды, боты, десктоп. Ценю чистую архитектуру и довожу проекты до рабочего результата. Открыт к заказам.',
    ...
    en: {
      ...
      'about.text': 'DigitalPr0 is a fullstack developer. I build websites, backends, Telegram bots and mobile apps tailored to the task. I work with Python, Node.js, PHP, Java, C# and Kotlin: REST and gRPC APIs, microservices, real-time chats, dashboards, bots, desktop. I value clean architecture and take projects all the way to a working result. Open to commissions.',
