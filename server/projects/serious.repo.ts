...
export const SERIOUS_PROJECTS_BASE = [
...

    {
        ...
        en: {
            name: "CRM dashboard with roles and permissions",
            summary:
...

    {
        ...
        en: {
            name: "Template-based document generator",
            summary:
...

    {
        ...
        en: {
            name: "Company database contact enrichment",
            summary:
